...
namespace Voxelisation {
    public class VoxelisationDriver : MonoBehaviour {
        ...
        public void addGrid(List<Voxelisation.Voxelization.AABCGrid> aABCGrids) {
                            ...
                            for (short y = 0; y < gridSize.y; ++y) {
                                for (short z = 0; z < gridSize.z; ++z) {
                                    ...
                                    if (aABCGrid.IsAABCSet(x, y, z)) {
                                        ...
                                        foreach (Vector3 point in destruction.getVoronoiPoints()) {
